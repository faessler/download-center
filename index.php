<html lang="en">
    <head>
        ...
        <style>input,label{display:block}.info__qmark,h1{color:#ecf0f1}body{margin:0 auto;width:100%;min-height:100vh;background-color:#2c3e50;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#2c3e50}.wrapper{width:600px;margin:60px auto}.content{padding:20px;background:#ecf0f1}form{margin-bottom:0}.formgroup{margin:20px 0 0}legend{margin:0;padding:0}label{font-size:80%;margin-bottom:3px}input{width:100%;padding:10px}.info{position:relative}.info__legend,.info__legend:before{position:absolute;background:#ecf0f1}.info__qmark{display:inline-block;width:12px;height:12px;line-height:12px;background:#2c3e50;font-size:70%;text-align:center;border-radius:100%;cursor:pointer}.info__legend{display:none;z-index:99;top:-10px;left:25px;width:200px;padding:10px;border:1px solid #2c3e50;border-radius:5px}.info__legend:before{content:"";top:12px;left:-6px;width:10px;height:10px;border-left:1px solid #2c3e50;border-bottom:1px solid #2c3e50;transform:rotate(45deg)}.info__legend:hover,.info__qmark:hover+.info__legend{display:block}input[type=checkbox]{height:14px;margin:0}input[type=submit]{appearance:none;-webkit-appearance:none;-moz-appearance:none;display:block;width:auto;padding:10px 20px;background:#2c3e50;border:1px solid #ecf0f1;color:#ecf0f1;cursor:pointer}input[type=submit]:hover{background:#ecf0f1;border:1px solid #2c3e50;color:#2c3e50}h3{margin-top:0}@media screen and (max-width:600px){body{background-color:#ecf0f1}.wrapper{margin:0 auto;width:100%}h1{color:#2c3e50;padding:20px;margin:0}}</style>
    </head>
    <body>
    <?php if (!empty($_POST)): ?>
        <div class="wrapper">
